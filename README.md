Bu proje, **Android Studio ve Kotlin** kullanarak geliştirilen basit bir "Kullanıcı giriş uygulamasıdır". Kullanıcıdan isim bilgisi alınıp bir sonraki sayfaya aktarılarılarak ekrana yazdırılır. 
